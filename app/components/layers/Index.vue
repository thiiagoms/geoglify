<template>
  <v-btn class="position-absolute" style="top: 10px; left: 10px; z-index: 1000" density="comfortable" rounded="md" size="small" @click="dialogOpened = true" icon="mdi-layers"></v-btn>
</template>
